...
class UserRepositoryTest {
    ...
    void findByUsernameAndPassword_ShouldReturnCustomer() {
        ...
        Optional<User> found = userRepository.findByUsernameAndPassword("johndoe", "password");
    ...
    void findByUsernameAndPassword_ShouldReturnEmpty_WhenInvalidCredentials() {
        ...
        Optional<User> found = userRepository.findByUsernameAndPassword("janedoe", "wrongpassword");
